...
export const metadata: Metadata = {
  title,
  description,
  alternates: { canonical: "/topics/policy-regulation-sustainability" },
  openGraph: {
    title,
    description,
    type: "website",
    url: "/topics/policy-regulation-sustainability",
  },
};

export default function PolicyRegulationSustainabilityTopic() {
  ...
  const structuredData = {
    ...
    name: title,
    description,
    url: "https://limhweechim.com/topics/policy-regulation-sustainability",
    author: {
      "@type": "Person",
      name: "Lim Hwee Chim",
  ...
  return (
    <Shell>
      ...
      <section className="latest section-pad" aria-labelledby="policy-regulation-sustainability-related">
        <div className="section-head">
          <div>
            <p className="eyebrow">Across the interfaces</p>
            <h2 id="policy-regulation-sustainability-related">Related articles</h2>
