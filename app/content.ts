...
const articleRegistry: Article[] = [
  {
    ...
    read: "12 min",
    featured: true,
    thumbnail: "/images/articles/before-construction-can-use-ai-it-has-to-remember/site-inspection-thumbnail.webp",
    thumbnailAlt: "Site inspector conducting an indoor project inspection",
